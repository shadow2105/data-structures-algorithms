public class TreeNode {
    ...
    public void insert(int value) {
        if(value==data) { return; }     // ignore duplicate values
    ...
    public void traversePreOrder() {
        ...
        if(leftChild!=null) { leftChild.traversePreOrder(); }

        if(rightChild!=null) { rightChild.traversePreOrder(); }
    }

    public void traversePostOrder() {
        if(leftChild!=null) { leftChild.traversePostOrder(); }

        if(rightChild!=null) { rightChild.traversePostOrder(); }
